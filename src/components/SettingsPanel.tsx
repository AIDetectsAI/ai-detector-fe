      ...
      <div className="settings-sections">
        <div className="settings-section">
          ...
          <div className="setting-item">
            ...
            <label className="toggle">
              <input type="checkbox" checked={darkMode} onChange={(e) => handleDarkMode(e.target.checked)} />
        ...
        <div className="settings-section">
          ...
          <div className="setting-item">
            <div className="setting-info">
              ...
              <span className="setting-desc">Automatically start analysis when an image is uploaded</span>
            </div>
            <label className="toggle">
        ...
        <div className="settings-section">
          ...
          <div className="setting-item">
            <div className="setting-info">
              ...
              <span className="setting-desc">Receive email updates about your analyses</span>
            </div>
            <label className="toggle">
        ...
        <div className="settings-section">
          ...
          <div className="setting-item danger">
            ...
            <button className="btn-danger" onClick={() => alert('Not implemented yet')}>
              Delete Account
            </button>
          </div>
        </div>
